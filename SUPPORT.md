# List of Models Supported by This Project

>  ### x86-64 Workflow

| 🖥️ Workflow Category            | Processor            | Notes         | LuCI Version        |
| ---------------- | -------------- | ---------- |---------- |
| x86-64 efi.img.gz  | Intel/AMD | EFI, backward-compatible with legacy BIOS |24.10.x |
| x86-64 OpenWrt Installer   | Intel/AMD | ISO format suitable for any virtual or physical machine; enter ddd after booting to install |24.10.x |

> ### QEMU-qcow2 ARM-64 Workflow
- This can be understood as a general-purpose OpenWrt build for ARM64 platforms. The output format is qcow2, suitable for virtual machines on all ARM64 platforms
- For example, it can be used on a Phicomm N1 running Armbian with a PVE virtual machine installed in Armbian
- For example, it can be used with the UTM virtual machine on newer Apple computers with Apple Silicon chips
- For example, it can be used on the official Debian system with PVE preinstalled for FriendlyARM NanoPi R3S and R5S
- For example, it can be used on a Radxa E20C running Armbian with a self-installed QEMU+KVM virtual machine

>  ### Rockchip Workflow
| 📦 Workflow Category     | Model                             | Manufacturer             | Processor Model | LuCI Version   |
|------------------|----------------------------------|------------------|-------------|------------|
| Rockchip    | ariaboard_photonicat             | Ariaboard        | RK3588      | 24.10.x    |
| Rockchip    | armsom_sige3                     | Armsom           | RK3568      | 24.10.x    |
| Rockchip    | armsom_sige7                     | Armsom           | RK3588      | 24.10.x    |
| Rockchip    | cyber_cyber3588-aib              | Cyber            | RK3588      | 24.10.x    |
| Rockchip    | ezpro_mrkaio-m68s                | EZPro            | RK3568      | 24.10.x    |
| Rockchip    | firefly_roc-rk3328-cc            | Firefly          | RK3328      | 24.10.x    |
| Rockchip    | firefly_roc-rk3568-pc            | Firefly          | RK3568      | 24.10.x    |
| Rockchip    | friendlyarm_nanopc-t4            | FriendlyARM      | RK3399      | 24.10.x    |
| Rockchip    | friendlyarm_nanopc-t6            | FriendlyARM      | RK3588      | 24.10.x    |
| Rockchip    | friendlyarm_nanopi-r2c           | FriendlyARM      | RK3328      | 24.10.x    |
| Rockchip    | friendlyarm_nanopi-r2c-plus      | FriendlyARM      | RK3328      | 24.10.x    |
| Rockchip    | friendlyarm_nanopi-r2s           | FriendlyARM      | RK3328      | 24.10.x    |
| Rockchip    | friendlyarm_nanopi-r3s           | FriendlyARM      | RK3568      | 24.10.x    |
| Rockchip    | friendlyarm_nanopi-r4s           | FriendlyARM      | RK3399      | 24.10.x    |
| Rockchip    | friendlyarm_nanopi-r4se          | FriendlyARM      | RK3399      | 24.10.x    |
| Rockchip    | friendlyarm_nanopi-r4s-enterprise| FriendlyARM      | RK3399      | 24.10.x    |
| Rockchip    | friendlyarm_nanopi-r5c           | FriendlyARM      | RK3568      | 24.10.x    |
| Rockchip    | friendlyarm_nanopi-r5s           | FriendlyARM      | RK3568      | 24.10.x    |
| Rockchip    | friendlyarm_nanopi-r6c           | FriendlyARM      | RK3588      | 24.10.x    |
| Rockchip    | friendlyarm_nanopi-r6s           | FriendlyARM      | RK3588      | 24.10.x    |
| Rockchip    | huake_guangmiao-g4c              | Huake            | RK3568      | 24.10.x    |
| Rockchip    | lunzn_fastrhino-r66s             | Lunzn            | RK3568      | 24.10.x    |
| Rockchip    | lunzn_fastrhino-r68s             | Lunzn            | RK3588      | 24.10.x    |
| Rockchip    | lyt_t68m                         | LYT              | RK3568      | 24.10.x    |
| Rockchip    | pine64_rock64                    | Pine64           | RK3328      | 24.10.x    |
| Rockchip    | pine64_rockpro64                 | Pine64           | RK3399      | 24.10.x    |
| Rockchip    | radxa_cm3_io                     | Radxa            | RK3566      | 24.10.x    |
| Rockchip    | radxa_e25                        | Radxa            | RK3568      | 24.10.x    |
| Rockchip    | radxa_rock-3a                    | Radxa            | RK3568      | 24.10.x    |
| Rockchip    | radxa_rock-3b                    | Radxa            | RK3568      | 24.10.x    |
| Rockchip    | radxa_rock-3c                    | Radxa            | RK3568      | 24.10.x    |
| Rockchip    | radxa_rock-5a                    | Radxa            | RK3588S     | 24.10.x    |
| Rockchip    | radxa_rock-5b                    | Radxa            | RK3588      | 24.10.x    |
| Rockchip    | radxa_rock-pi-4a                 | Radxa            | RK3399      | 24.10.x    |
| Rockchip    | radxa_rock-pi-e                  | Radxa            | RK3328      | 24.10.x    |
| Rockchip    | radxa_rock-pi-s                  | Radxa            | RK3308      | 24.10.x    |
| Rockchip    | radxa_zero-3e                    | Radxa            | RK3566      | 24.10.x    |
| Rockchip    | radxa_zero-3w                    | Radxa            | RK3566      | 24.10.x    |
| Rockchip    | sinovoip_bpi-r2-pro              | SinoVoip         | RK3568      | 24.10.x    |
| Rockchip    | xunlong_orangepi-5               | OrangePi          | RK3588S     | 24.10.x    |
| Rockchip    | xunlong_orangepi-5-plus          | OrangePi          | RK3588      | 24.10.x    |
| Rockchip    | xunlong_orangepi-r1-plus         | OrangePi          | RK3328        | 24.10.x    |
| Rockchip    | xunlong_orangepi-r1-plus-lts     | OrangePi          | RK3328        | 24.10.x    |

> ### Raspberry Pi 1–5 Workflow
| 📦 Development Board Category     | Model               | Manufacturer        | Processor Model        | LuCI Version   |
|------------------|--------------------|-------------|-------------------|------------|
| Broadcom     | raspberrypi_1_model_b     | Raspberry Pi | BCM2835 (ARMv6)   | 24.10.x    |
| Broadcom     | raspberrypi_2_model_b     | Raspberry Pi | BCM2836 (ARMv7)   | 24.10.x    |
| Broadcom     | raspberrypi_3_model_b     | Raspberry Pi | BCM2837 (ARM Cortex-A53) | 24.10.x |
| Broadcom     | raspberrypi_3_model_b_plus| Raspberry Pi | BCM2837B0         | 24.10.x    |
| Broadcom     | raspberrypi_4_model_b     | Raspberry Pi | BCM2711 (Cortex-A72) | 24.10.x |
| Broadcom     | raspberrypi_5             | Raspberry Pi | BCM2712 (Cortex-A76 + RPI RP1) | 24.10.x |

> ### Allwinner sunxi-cortexa53 Workflow
...
> ### ~~GL.iNet and Cudy MediaTek Filogic Workflow~~ Moved into build-wireless-router.yml

| 📦 SoC Platform                         | Model                           | Manufacturer       | Processor Model     | LuCI Version   |
|-----------------------------------|--------------------------------|------------|----------------|------------|
...
> ### The following devices are not officially supported by OpenWrt, but img files can be generated in a second stage using the Flippy packaging tool

| 📦 Boot Method / Category            | Model       | Manufacturer      | Processor/Chipset        | Description          |
| ----------------------- | -------- | ------- | -------------- | ----------- |
| Flippy-compatible device (armsr-armv8) | e20c     | Radxa   | RK3528A     | Requires packaging with the Flippy tool |
| Flippy-compatible device (armsr-armv8) | e24c     | Radxa   | RK3528A        | Requires packaging with the Flippy tool |
| Flippy-compatible device (armsr-armv8) | e25      | Radxa   | RK3568        | Officially supported by OpenWrt / packaged with the Flippy tool |
| Flippy-compatible device (armsr-armv8) | e52c     | Radxa     | RK3582        | Requires packaging with the Flippy tool |
| Flippy-compatible device (armsr-armv8) | e54c     | Radxa     | RK3582        | Requires packaging with the Flippy tool |
| Flippy-compatible device (armsr-armv8) | rock5b   | Radxa   | RK3588         | High-performance SBC      |
| Flippy-compatible device (armsr-armv8) | rock5c   | Radxa   | RK3588S        | Compact version       |
| Flippy-compatible device (armsr-armv8) | r66s     | Lunzn   | RK3568         | Officially supported by OpenWrt / lunzn_fastrhino-r66s        |
| Flippy-compatible device (armsr-armv8) | r68s     | Lunzn   | RK3568         | Officially supported by OpenWrt / lunzn_fastrhino-r68s         |
| Flippy-compatible device (armsr-armv8) | ht2      | Unspecified     | RK3328       | TV box       |
| Flippy-compatible device (armsr-armv8) | h28k     | HINLINK | Amlogic S905X3 | TV box        |
| Flippy-compatible device (armsr-armv8) | h66k     | HINLINK | Amlogic S922X  |             |
| Flippy-compatible device (armsr-armv8) | h68k     | HINLINK | Amlogic S922X  |             |
| Flippy-compatible device (armsr-armv8) | h69k     | HINLINK | Amlogic S922X  |             |
| Flippy-compatible device (armsr-armv8) | h69k-max | HINLINK | Amlogic S922X  | Max version with expanded memory  |
| Flippy-compatible device (armsr-armv8) | h88k     | HINLINK | Amlogic S922X  |             |
| Flippy-compatible device (armsr-armv8) | h88k-v3  | HINLINK | Amlogic S922X  | Third version        |
| Flippy-compatible device (armsr-armv8) | jp-tvbox | Unspecified     | Amlogic S905X3 | Modified TV box       |
| Flippy-compatible device (armsr-armv8) | l1pro    | Unspecified     | RK3588S        | Compact software router       |
| Flippy-compatible device (armsr-armv8) | s905     | Multiple manufacturers     | Amlogic S905   | Early TV-box chipset     |
| Flippy-compatible device (armsr-armv8) | s905x2   | Multiple manufacturers     | Amlogic S905X2 |             |
| Flippy-compatible device (armsr-armv8) | s905x3   | Multiple manufacturers     | Amlogic S905X3 |             |
| Flippy-compatible device (armsr-armv8) | s912     | Multiple manufacturers     | Amlogic S912   |             |
| Flippy-compatible device (armsr-armv8) | s922x    | Multiple manufacturers     | Amlogic S922X  | Odroid N2 chipset |
| Flippy-compatible device (armsr-armv8) | s922x-n2 | Odroid  | Amlogic S922X  | Highly compatible device      |

> ### Phicomm N1 TV Box
> The armsr-armv8 rootfs is built and then packaged into an OpenWrt image with the Flippy packaging tool<br>
> Because the user base is relatively large, a separate build-n1.yml workflow is provided to support builds for specific kernel versions

### Amlogic TV Boxes and Some Development Boards
...
>  ### MediaTek Router Workflow (Approximately 103 Models) — build-wireless-router.yml
...
> ### Hardware Router Firmware Format Descriptions

| File Type | Purpose        | Contents               | Common Use Cases             |
| ---- | --------- | ---------------- | ---------------- |
| FIP  | Arm firmware package   | BL1/BL2/BL31, etc.   | CPU power-on boot         |
| BIN  | Generic binary      | Bootloader/kernel, etc.   | Flashing or loading for execution          |
| UBI  | NAND file system | UBIFS image         | Embedded NAND routers/development boards |
| ITB  | U-Boot image | Kernel + device tree + initramfs | U-Boot boot image      |
